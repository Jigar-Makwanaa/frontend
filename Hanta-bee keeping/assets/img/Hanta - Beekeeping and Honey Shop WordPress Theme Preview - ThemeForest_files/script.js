(function($) {
	...
	$(document).ready(function() {
      $('select:not(.ignore, .comment-form #rating, .tinvwl-input-group select, .wp-block-archives-dropdown select, .address-field select, .sidebar-widget select, #pa_size, #pa_color, .variations.variation-table select, .widget_archive select, .widget_categories select,.wp-block-categories select)').niceSelect();
    });
